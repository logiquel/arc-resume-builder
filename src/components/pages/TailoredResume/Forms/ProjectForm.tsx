...
const ProjectForm = () => {
  ...
  const updateField = (
    field: keyof Omit<ProjectFormData, "description">,
    value: string,
  ) => {
      ...
      <div className="w-120 flex flex-col bg-white border border-black/10 shadow-2xl rounded-3xl ring-4 ring-white/50">
        <header className="w-full flex gap-2 p-3 justify-between shrink-0">
          <div className="flex items-center">
            <Icon icon="famicons:cube-outline" className="text-brand" />
        ...
        <div className="w-full grid grid-cols-4 gap-x-5 gap-y-4 p-4 overflow-hidden">
          <fieldset className="min-w-0 flex flex-col gap-y-1.5 col-span-2">
            ...
            <AutoTextarea
              ...
              placeholder="e.g. AI Resume Tailoring Platform"
            />
          </fieldset>
          ...
          <fieldset className="min-w-0 flex flex-col gap-y-1.5 col-span-2">
            ...
            <AutoTextarea
              ...
              placeholder="e.g. Full-stack platform for resume optimization and preview"
            />
          </fieldset>
              ...
              {formData.description.map((bullet, index) => (
                <div key={index} className="flex items-start gap-2">
                  ...
                  <textarea
                    ...
                    rows={1}
                    value={bullet}
                    placeholder="Describe a feature, impact, or technical highlight…"
                    onChange={(e) => {
